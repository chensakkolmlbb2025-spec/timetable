...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        // ensure RTL icon rotation remains supported
      ...
      classNames={{
  // make calendar take available width to avoid cramped layouts
  root: cn("w-full", defaultClassNames.root),
        ...
        // keep nav in the normal flow so it doesn't overlap the month grid or surrounding layout
        nav: cn(
        ...
        month_caption: cn(
          "flex items-center justify-center h-[var(--cell-size)] w-full px-[calc(var(--cell-size)/2)]",
